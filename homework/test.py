...
class TestSuite(unittest.TestCase):
    ...
    @cases([
        ...
        {"phone": "notaphonenumber", "email": "email@example.com"},  # некорректный номер телефона
        ...
        {"email": "example.com", "first_name": "Test", "last_name": "User"},  # email без '@'
        {"phone": "712345678901", "email": "email@example.com"},  # слишком длинный телефонный номер
        {"phone": "61234567890", "email": "email@example.com"},  # номер телефона не начинается с '7'
    ])
    ...
    @cases([
        ...
        {"client_ids": [1, None, 3], "date": "01.01.2020"},  # client_ids содержит пустоту
        {"client_ids": [1, "2", 3], "date": "01.01.2020"},  # client_ids сожержит строку
